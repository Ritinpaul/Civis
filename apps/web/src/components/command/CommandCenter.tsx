...
export function CommandCenter() {
  ...
  return (
    <div className="p-3 md:p-4 w-full h-[calc(100vh-3.5rem)] flex flex-col gap-3 select-none overflow-y-auto lg:overflow-hidden bg-[#07080B] font-sans">
      {/* Top 1-Row Technical Telemetry Bar */}
      <div className="h-10 px-4 rounded-xl bg-[#0B0D13] border border-white/[0.08] flex items-center justify-between gap-4 text-xs font-sans shrink-0 shadow-lg">
        ...
        <div className="flex items-center gap-2">
          <LayersIcon className="w-3.5 h-3.5 text-indigo-400 shrink-0" />
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className={`text-[9.5px] px-1.5 py-0.2 rounded font-bold font-mono ${
              isResolved
        ...
        <div className="hidden md:flex items-center gap-2">
          <CheckCircledIcon className="w-3.5 h-3.5 text-purple-400 shrink-0" />
          <span className="text-[#71717A]">TRUST:</span>
          <span className="font-bold text-purple-400">{metrics.trustScore}%</span>
          <span className="text-[9.5px] text-emerald-400 px-1.5 py-0.2 rounded bg-emerald-500/10 border border-emerald-500/20 font-mono">
            100% Gated
          </span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="font-medium text-[#EDEDEF] text-[11px] font-mono">
      ...
      {/* Main Two-Column Operations Dashboard */}
      <div className="flex-1 flex flex-col lg:flex-row items-stretch gap-3 min-h-0">
        ...
        {/* Right Column: Tactical Map + Diagnostics Dock */}
